const produits = {
  arbres: [
    ...
    },
    {
      ...
      description:
        "Un arbre d'intérieur populaire avec de grandes feuilles en forme de violon.",
      prix: 50,
    ...
    },
    {
      ...
      description:
        "Un arbre majestueux à feuilles composées et à fleurs blanches.",
      prix: 10,
    ...
    },
    {
      ...
      nom: "Pin parasol",
      description:
        "Un pin méditerranéen à la silhouette caractéristique en forme de parasol.",
      prix: 150,
    ...
    },
    {
      ...
      nom: "Magnolia",
      description:
        "Un arbre aux grandes fleurs parfumées et au feuillage persistant.",
      prix: 110,
  ...
  fleurs: [
    {
      ...
      nom: "Haworthia",
      description:
        "Une petite plante succulente aux feuilles charnues et pointues.",
      prix: 25,
    ...
    },
    {
      ...
      nom: "Adenium obesum",
      description:
        "Une plante succulente aux fleurs spectaculaires et au tronc épais.",
      prix: 30,
    ...
    },
    {
      ...
      description:
        "Une plante grimpante aux feuilles panachées et aux fleurs en étoile.",
      prix: 15,
  ...
  materiel: [
    ...
    },
    {
      ...
      description:
        "Appareil pour nettoyer efficacement les surfaces extérieures.",
      prix: 400,
      image:
        "Images/hnhp2470-nettoyeur-haute-pression-electrique-2400-w-170-bar-480-l-h.jpg",
    ...
    },
    {
      ...
      prix: 5,
      image:
        "Images/1698915165dc3a270eeec5476d9a487c228fc13e1d_thumbnail_720x.jpg",
